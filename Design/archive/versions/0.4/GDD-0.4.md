...
Revision 0.4 · 16 September 2026 · Proposed design
...
The kit separates ground, props, people, signs and building parts. It can be extended without repainting a whole scene. These department buildings are fictional test objects; they do not establish the case’s location or legal structure.
...
The roof toggle changes visibility. The five views change what the inspector explains. Neither changes the selected building’s identity or the underlying fixture. Cash events appear in their own record strip, never as money travelling along a footpath.
...
| Three buildings with removable roofs and shared furnishings | Walk a person behind a wall, through a doorway and past furniture without overlap errors |

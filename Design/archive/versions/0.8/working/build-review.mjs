...
import { marked } from '/Users/juliacompton/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/node_modules/marked/lib/marked.esm.js';
...
Object.assign(figures,artFigures,officeFigures,bindingFigures,parkFigures,materialFigures);
...
const routesByFile={'GDD.md':'game','evidence-map.md':'evidence','research/systems.md':'research-systems','research/ux.md':'research-ux','research/visual-craft.md':'research-art','research/office-art-research.md':'research-offices','research/campus-discoveries.md':'research-discoveries','research/park-logic-review.md':'research-park','binding/episode-01-draft.md':'binding','binding/native-inventory.md':'binding-inventory'};
...
for(const p of pages){
 ...
 html=html.replace(/href="([^"#][^"]*)"/g,(full,href)=>{
   ...
   if(href.startsWith('/')){const decoded=decodeURI(href);const moved=decoded.replace('/Users/juliacompton/Library/Mobile Documents/com~apple~CloudDocs/ICLOUD-bridge/_ALLM/Codex-BR/Games/Mad Money Tycoon',path.resolve(root,'..')).replace('/Users/juliacompton/Library/Mobile Documents/com~apple~CloudDocs/ICLOUD-bridge/Codex/Games/Mad Money Tycoon',path.resolve(root,'..'));return `href="${esc(encodeURI(moved))}" target="_blank"`;}

...
Design 0.9 / art 0.8. These results cover the current reader and export system. Earlier checks are in the archive.
...
| `interaction-checks.json` | Catalogue filtering/playback/download, version changes, separate form specimen and park controls |

...
for(const p of pages){
 ...
 html=html.replace(/<p>(<img[^>]+>)<\/p>/g,(_,img)=>{
  ...
  return `<figure class="inline-example"><a href="${href}">${img}</a><figcaption>${alt}<a href="${href}">${object?'Inspect '+object:catalogue?'Inspect catalogue':'Open source image'} ↗</a></figcaption></figure>`;
 });
